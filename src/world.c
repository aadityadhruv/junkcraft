...
void world_all_chunk_gen_biome() {
    ...
    //         float s = noise_biome(i, j);
    //         if (s > 0.8f) {
    //             chunk_biomes[i][j] = JUNK_BIOME_MOUNTAINS;
    //         }
    //         else if (s > 0.6f) {
    //             chunk_biomes[i][j] = JUNK_BIOME_SNOW;
    //         }
    //         else if (s > 0.4f) {
    //             chunk_biomes[i][j] = JUNK_BIOME_PLAINS;
    //         }
    //         else if (s > 0.2f) {
    //             chunk_biomes[i][j] = JUNK_BIOME_DESERT;
    //         }
    //         else {
    //             chunk_biomes[i][j] = JUNK_BIOME_PLAINS;
    //         }
